...
public class JTpiece extends JFrame {
	...
	public JTpiece() {
		...
		setTitle("Tetris V1 - by Jkutney21");
		setIconImage(Toolkit.getDefaultToolkit().getImage(JTpiece.class.getResource("/ICO/ICO.png")));
